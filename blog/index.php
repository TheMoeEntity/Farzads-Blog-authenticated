...
<head>
    ...
    <title>Farzad Nosrati | Blog</title>
    ...
    <div class="modal-background" id="modal-background">
        ...
        <div>
            ...
            <form id="contactForm">
                ...
                <div class="g-recaptcha my-3 mx-auto px-auto w-100"
                    data-sitekey="6Lffn8opAAAAAMv9AEWbiuPA6UVRaDILxLTPO3II" data-callback="handleRecaptchaCallback">
                </div>
                <!-- Submit Button-->
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <section id="blog" class="blog">
                    ...
                    <div class="container" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="row gy-4 posts-list d-flex justify-content-center justify-content-md-start"
                            id="blogList2">
